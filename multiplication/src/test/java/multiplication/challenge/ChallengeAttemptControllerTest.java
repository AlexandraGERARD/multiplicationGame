...
class ChallengeAttemptControllerTest {
    ...
    void postValidResult() throws Exception {
        ...
        MockHttpServletResponse response =
                mvc.perform(post("/attempts").contentType(MediaType.APPLICATION_JSON).content(jsonRequestAttempt.write(attemptDTO).getJson())).andReturn().getResponse();
    ...
    public void getUserStats() throws Exception {
        ...
        // WHEN
        MockHttpServletResponse response =
                mvc.perform(get("/attempts").param("alias", "john_doe")).andReturn().getResponse();
