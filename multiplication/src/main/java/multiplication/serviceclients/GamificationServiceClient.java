package multiplication.serviceclients;

import gamification.challenge.ChallengeSolvedDTO;
import lombok.extern.slf4j.Slf4j;
import multiplication.challenge.ChallengeAttempt;
...
public class GamificationServiceClient {
    ...
    public boolean sendAttempt(final ChallengeAttempt attempt) {
        try {
            ChallengeSolvedDTO dto = new ChallengeSolvedDTO(attempt.getId(), attempt.isCorrect(),
